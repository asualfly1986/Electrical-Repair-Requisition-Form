...
const SheetsManager = {
  ...
  getSettings() {
    const defaultSettings = {
      ...
      memoBody: "เนื่องด้วย คลังแก้กระแสไฟฟ้าขัดข้อง ผปบ.กฟส.ขก.2 มีความจำเป็นต้องสำรองพัสดุอุปกรณ์งานแก้กระแสไฟฟ้าขัดข้อง เพื่อใช้สำรองคลังฉุกเฉินสำหรับงานแก้กระแสไฟฟ้าขัดข้อง ให้สอดคล้องกับการใช้งานจริง\nดังนั้น คลังแก้กระแสไฟฟ้าขัดข้อง ผปบ.กฟส.ขก.2 จึงขออนุมัติเบิกพัสดุอุปกรณ์สำรองคลังฉุกเฉินแก้กระแสไฟฟ้าขัดข้อง ตามแนบรายการเบิกพัสดุคลังแก้กระแสไฟฟ้าขัดข้อง\n\nจึงเรียนมาเพื่อโปรดพิจารณาอนุมัติ"
    };
